    ...
    Api.get('/drivers/profile')
      .then(res => {
        this.setState({
          ...
          model: res.data.vehicle
            ? `${res.data.vehicle.model} ${res.data.vehicle.year}`
            : '',
          license_plate: res.data.vehicle ? res.data.vehicle.license_plate : '',
          organization: res.data.vehicle
            ? `${res.data.vehicle.organization.name} ${res.data.vehicle.number}`
            : ''
        });
      })
          ...
          <View style={styles.darkFieldWrapper}>
            ...
            <View style={styles.rowWrapper}>
              ...
              <Button
                transparent
                onPress={() => {
                  this.props.navigation.navigate('EditLicense');
                }}
              >
                <Icon name="create" style={styles.menuIcon} />
              </Button>
